...
public class LeavesBlockThree extends LeavesBlock{
    public static final PropertyEnum<LogBlockOne.LogType> VARIANT = PropertyEnum.create("variant", LogBlockOne.LogType.class, ty -> ty.meta >= 8 && ty.meta < 9);

    public LeavesBlockThree() {
        this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, LogBlockOne.LogType.ASPEN));
    }
    ...
    public IBlockState getStateFromMeta(int meta) {
        LogBlockOne.LogType variant = LogBlockOne.LogType.fromMeta((meta & 3) + 8);
