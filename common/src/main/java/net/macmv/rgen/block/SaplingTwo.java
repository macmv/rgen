...
public class SaplingTwo extends Sapling {
  ...
  public SaplingTwo(BlockSettings settings) {
    this.setDefaultState(this.blockState.getBaseState().withProperty(TYPE, LogType.ASPEN).withProperty(STAGE, 0));
  }
