...
public class DoubleTallLavenderPlant extends BlockBush {
  ...
  public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {
    ...
    IBlockState lowerState = this.getDefaultState().withProperty(VARIANT, EnumVariant.byMetadata(randomVariant)).withProperty(HALF, BlockDoublePlant.EnumBlockHalf.LOWER);

    IBlockState upperState = this.getDefaultState().withProperty(VARIANT, EnumVariant.byMetadata(randomVariant)).withProperty(HALF, BlockDoublePlant.EnumBlockHalf.UPPER);
