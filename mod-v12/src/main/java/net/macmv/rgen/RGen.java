...
@Mod(modid = RGen.MOD_ID, version = RGen.VERSION)
@Mod.EventBusSubscriber(value = Side.CLIENT, modid = RGen.MOD_ID)
public class RGen {
  public static final String MOD_ID = "rgen";
  public static final String VERSION = "1.0";
  public static Logger LOG = LogManager.getLogger(RGen.MOD_ID);
